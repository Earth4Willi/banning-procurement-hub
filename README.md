...
- Logo: `public/main-logo.jpg` (copy of the master banner logo, `logo/logo main 2.jpg`, 1152×561) is the site's sole mark — header/footer logo chip, favicon (`src/app/icon.png`), PWA icons and the social card (`public/og.png`).
